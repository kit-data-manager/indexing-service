...
public class OpenApiDefinitions {
  ...
  public OpenAPI customOpenAPI() {
    return new OpenAPI()
            ...
            .info(new Info().title("Indexing and Mapping Microservice - RESTful API").
                    description("This webpage describes the RESTful interface of "
                            + "the KIT Data Manager Indexing and Mapping Microservice.").
                    version("1.0.0").
                    contact(
                            new Contact().
